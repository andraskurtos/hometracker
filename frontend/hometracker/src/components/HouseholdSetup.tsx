    ...
    <div className="w-full max-w-6xl mx-auto flex flex-col items-center justify-center min-h-[70vh] px-6 py-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="text-5xl font-black tracking-tight text-neutral-100 mb-4">
          Establish Your Household
        </h1>
        <p className="text-xl text-neutral-500 max-w-2xl mx-auto">
          HomeTracker works best when you're part of a household. Create a new one for your family or join an existing one.
        </p>
      </div>
        ...
        <div className="flex flex-col p-10 rounded-[2.5rem] bg-neutral-900/40 border border-neutral-800/60 backdrop-blur-xl relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-2xl font-bold text-neutral-100">Create New</h2>
            </div>

            <form onSubmit={handleCreate} className="space-y-6 flex-1 flex flex-col">
              <div className="space-y-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-neutral-500 uppercase tracking-widest ml-1">Household Name</label>
                  <input
                    type="text"
                    required
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-neutral-500 uppercase tracking-widest ml-1">Description (Optional)</label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-neutral-500 uppercase tracking-widest ml-1">Base Currency</label>
                  <select
              ...
              >
                {isLoading === 'create' ? <Loader2 className="animate-spin" /> : 'Initialize Household'}
              </button>
            </form>
          </div>
        </div>
        ...
        <div className="flex flex-col p-10 rounded-[2.5rem] bg-neutral-900/40 border border-neutral-800/60 backdrop-blur-xl relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-2xl font-bold text-neutral-100">Join Existing</h2>
            </div>

            <p className="text-neutral-400 mb-8 leading-relaxed">
              Have a code from a roommate or family member? Enter it here to sync your pantry and expenses instantly.
            </p>

            <form onSubmit={handleJoin} className="space-y-6 flex-1 flex flex-col justify-center">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-neutral-500 uppercase tracking-widest ml-1">Join Code</label>
                <input
                  type="text"
                  required
                  value={joinCode}
              ...
              >
                {isLoading === 'join' ? <Loader2 className="animate-spin" /> : <>Connect to Household <ArrowRight className="ml-2" size={20} /></>}
              </button>
            </form>
          </div>
        </div>
